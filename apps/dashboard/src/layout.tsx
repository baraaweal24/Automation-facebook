...
export function Layout() {
  ...
  return <div className="min-h-screen">
    <aside className={`fixed inset-y-0 right-0 z-40 w-72 bg-ink text-white transition-transform lg:translate-x-0 ${open ? 'translate-x-0' : 'translate-x-full'}`}>
