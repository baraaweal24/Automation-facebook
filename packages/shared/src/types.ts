...
export const TASK_TYPES = ['SYNC_JOINED_GROUPS', 'DISCOVER_GROUPS', 'ANALYZE_GROUP', 'JOIN_GROUP', 'SUBMIT_GROUP_QUESTIONS', 'CHECK_JOIN_STATUS', 'PUBLISH_JOB', 'PUBLISH_POST', 'CHECK_POST_STATUS', 'REFRESH_GROUP_STATS', 'CLEANUP_SCREENSHOTS', 'CHECK_FACEBOOK_SESSION'] as const;
